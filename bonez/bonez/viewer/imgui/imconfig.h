...
namespace ImGui
{
    void Value(const char* prefix, const BnZ::Vec4f& v, const char* float_format = nullptr);
    void Value(const char* prefix, const BnZ::Vec3f& v, const char* float_format = nullptr);
